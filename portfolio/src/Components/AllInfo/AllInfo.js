...
import '../AllInfo/AllInfo.css'
import Card from '../Card/Card';
import web1 from '../../Images/web1.png';

const proyects = [
  { link: "https://github.com/Luciana444/TrabajoWeb1", id: 1, name: "Angular", description: "Description...", img: web1 },
  { link: "https://github.com/Luciana444/TrabajoWeb1", id: 2, name: "web2", description: "Description...", img: web1 },
  { link: "https://github.com/Luciana444/TrabajoWeb1", id: 3, name: "angular", description: "Description...", img: web1 },
  { link: "https://github.com/Luciana444/TrabajoWeb1", id: 4, name: "angular", description: "Description...", img: web1 },
  { link: "https://github.com/Luciana444/TrabajoWeb1", id: 5, name: "angular", description: "Description...", img: web1 }
];

const technologies = [
  { id: 1, name: "React", description: "Description...", img: web1 },
  { id: 2, name: "Java", description: "Description...", img: web1 },
  { id: 3, name: "React", description: "Description...", img: web1 },
  { id: 4, name: "Java", description: "Description...", img: web1 }
];
